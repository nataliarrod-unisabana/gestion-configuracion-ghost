...
| 18_actions_workflows.png | Los workflows registrados en la pestaña Actions |
...
|---------|--------------------|
| 22_grafo_ramas.png | Grafo de ramas con las etiquetas de main, develop y las feature, y los commits de merge |
| 23_tag_v100.png | El tag v1.0.0 con su fecha y commit |
| 24_release_publicada.png | La release v1.0.0 con casper.zip y source.zip adjuntos |
| 25_pipeline_release.png | La ejecución del workflow Release disparada por el tag, en verde |

Una vez publicado el release, repetir `18_actions_workflows.png` para que
incluya también el workflow de release.
